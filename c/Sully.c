...
#define MAIN()
    int main()
    {
        ...
        if (x <= 0) return 0;
        snprintf(filename, sizeof(filename), "Sully_%d.c", x - 1);
        snprintf(execname, sizeof(execname), "Sully_%d", x - 1);
